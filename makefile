...
app: main.gch GeneticAlgorithm.gch Chromosome.gch Graph.gch DoubleRomanDomination.gch
	g++ $(OBJ)main.gch $(OBJ)GeneticAlgorithm.gch $(OBJ)Chromosome.gch $(OBJ)Graph.gch $(OBJ)DoubleRomanDomination.gch -o app
